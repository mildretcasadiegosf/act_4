 ...
 */
export const GastoListWithMetadataSchema = z.object(
  {
  ...
  {
    description: 'Respuesta de listado de gastos con metadatos',
  }
);
...
export const NuevoGastoRequestSchema = z.object(
  ...
  {
    description: 'Solicitud para crear un nuevo gasto',
  }
);
...
export const GastoCreatedResponseSchema = GastoIndividualSchema.extend(
  ...
  {
    description: 'Respuesta de creación de gasto con timestamps',
  }
);
 ...
 */
export const GastoDeletionResponseSchema = z.object(
  {
    success: z.boolean(),
  ...
  {
    description: 'Respuesta de eliminación de gasto',
  }
);
...
export const ValidationErrorSchema = z.object(
  ...
  {
    description: 'Error de validación en solicitud POST/PUT',
  }
);
...
export const UnauthorizedErrorSchema = z.object(
  ...
  {
    description: 'Error de autenticación requerida',
  }
);
